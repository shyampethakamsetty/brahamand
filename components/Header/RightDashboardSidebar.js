...
const RightDashboardSidebar = () => {
  const { shouldCollapseRightbar, setShouldCollapseRightbar } = useAppContext();
  ...
  return (
    <>
      <div
        ref={sidebarRef}
        style={{ background: '#f8f8ff !important' }}
        className={`rbt-right-side-panel popup-dashboardright-section  ${
          shouldCollapseRightbar ? "collapsed" : ""
        }`}
      >
        <div className="right-side-top" style={{ background: '#f8f8ff !important' }}>
          <a
